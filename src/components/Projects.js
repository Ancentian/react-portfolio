      ...
      <Container>
        <Row>
          <Col>
            <h2>Projects</h2>
            <p>
              I am still working to learn more languages, so I can't do that
              just yet. Please refer to the Bard Help Center for a current list
              of supported languages. Is there anything else you'd like my help
              with?
            </p>
